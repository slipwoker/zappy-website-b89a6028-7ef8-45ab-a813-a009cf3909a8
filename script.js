    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      fields.forEach(function(field) {
        ...
        if (field.hasAttribute('minlength') && value.length < parseInt(field.getAttribute('minlength'))) {
          errorMessage = field.getAttribute('data-error-minlength') || 'Minimum length is ' + field.getAttribute('minlength') + ' characters.';
          isValid = false;
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'b89a6028-7ef8-45ab-a813-a009cf3909a8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'b89a6028-7ef8-45ab-a813-a009cf3909a8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b89a6028-7ef8-45ab-a813-a009cf3909a8';
